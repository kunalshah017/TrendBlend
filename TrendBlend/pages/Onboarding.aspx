<%@ Page Title="" Language="C#" MasterPageFile="~/layouts/PublicLayout.Master" AutoEventWireup="true"
    CodeBehind="Onboarding.aspx.cs" Inherits="TrendBlend.pages.WebForm4" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="main_container">
            ...
            <div class="cta_button_container">
                <div>
                    <asp:Button runat="server" Text="Sign In" CssClass="cta_button" ID="SignInButton"
                        OnClick="SignInButton_Click" />
                </div>
                <div>
                    <asp:Button runat="server" Text="Register" CssClass="cta_button" ID="RegisterButton"
